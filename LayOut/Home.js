    ...
    return (
        <View style={{flex: 1,backgroundColor:'#ececec'}}>
            <View style={{height:70,flexDirection:'row-reverse',backgroundColor:'white'}}>
                ...
                <TouchableOpacity style={{height:50,width:50,borderRadius:50/2,backgroundColor:'#ececec',marginRight:15,marginVertical:10,justifyContent:'center',alignItems:'center'}}>
                    <RnIcon name="notifications-outline" size={30} color="black"/>
                    
                </TouchableOpacity>
                <TouchableOpacity style={{height:50,width:80,borderRadius:50/2,backgroundColor:'#ececec',marginHorizontal:15,marginVertical:10,justifyContent:'center',alignItems:'center',flexDirection:'row'}}>
            ...
            <ScrollView style={{flex: 1,width:'94%',marginLeft:'3%',backgroundColor:'#ececec',borderRadius:5,}}>
                <View style={{height:120,marginTop:10,width:'100%',borderColor:'#ececec',backgroundColor:'white',borderWidth:1,borderRadius:10,flexDirection:'row',justifyContent:"center",alignItems:"center"}}>
                    <TouchableOpacity style={{height:100,width:'48%',backgroundColor:'white',justifyContent:"center",alignItems:"center",borderRadius:10}}>
                        <RnIcon1 name="truck-delivery" size={70} color="orange"/>
                    ...
                    <TouchableOpacity style={{height:100,width:'48%',borderRadius:10,backgroundColor:'white',justifyContent:"center",alignItems:"center"}}>
                        <RnIcon2 name="shopping-bag-1" size={70} color="orange"/>
            ...
            <View style={{height:60,flexDirection:'row', justifyContent:'center',alignItems:'center',backgroundColor:'white'}}>
                <TouchableOpacity style={{flex:1, justifyContent:'center',alignItems:'center',}}>
                    ...
                    <Text style={{fontWeight:'bold',color:'orange'}}>Trang Chủ</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{flex:1, justifyContent:'center',alignItems:'center',}}>
